...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://intelligent-quoter.preview.emergentagent.com')
...
class TestCatalogUrlBuilder:
    ...
    def test_catalog_url_format(self):
        ...
        base_url = "https://intelligent-quoter.preview.emergentagent.com"
